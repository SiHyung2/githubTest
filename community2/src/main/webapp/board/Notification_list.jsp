...
<body>
	...
	<div class="container">
		<form action="<c:url value="./Notification_BoardListAction.do"/>" method="post">
			<div>
				<div class="text-right">
					<span class="badge badge-success">전체 <%=Notification_total_record%>건	</span>
				</div>
			</div>
			<div style="padding-top: 50px">
				<table class="table table-hover">
					...
					<tr>
						<td><%=notice.getNum()%></td>
						<td><a href="./Notification_BoardViewAction.do?num=<%=notice.getNum()%>&Notification_pageNum=<%=Notification_pageNum%>"><%=notice.getSubject()%></a></td>

...
<body>
	...
	<div class="container">
		<form action="<c:url value="./Popular_BoardListAction.do"/>" method="post">
			<div>
				<div class="text-right">
					<span class="badge badge-success">전체 <%=Popular_total_record%>건	</span>
				</div>
			</div>
			<div style="padding-top: 50px">
				<table class="table table-hover">
					...
					<tr>
						<td><%=notice.getNum()%></td>
						<td><a href="./Popular_BoardViewAction.do?num=<%=notice.getNum()%>&pageNum=<%=Popular_pageNum%>"><%=notice.getSubject()%></a></td>
			...
			<div align="center">
				...
				<c:forEach var="i" begin="1" end="<%=Popular_total_page%>">
					<a href="<c:url value="./Popular_BoardListAction.do?pageNum=${i}" /> ">
						<c:choose>

			...
			<section>
				<aside>
					<div class="image_post">
						...
						<div>
<!-- 						가장 hit가 높은 게시물의 주소를 출력하게 만들것이지만 버그 발생됨 -->
							<%
							...
							%>
							<a href="/community2/Popular_BoardViewAction.do?num=<%=max_hit_of_num%>&pageNum=<%=Popular_pageNum%>"><%=notice.getSubject()%></a>
							<%
								}
							}
							%>
				...
				<div class="post_list">
					...
					<%
								...
								<tr>
									<td><%=notice.getNum()%></td>
									<td><a href="/community2/Popular_BoardViewAction.do?num=<%=notice.getNum()%>&pageNum=<%=Popular_pageNum%>"><%=notice.getSubject()%></a></td>
								</tr>
								<%
									}
								%>

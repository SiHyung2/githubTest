	...
	<div class="wrapper">
		...
		<section id="popular">
			<header>
              ...
              이동하기 위함이다 -->
				<div>
					<a  href="<c:url value="/BoardListAction.do?pageNum=1&board_type=popular"/>">인기 게시판</a>
				</div>
				<div>
					<a  href="<c:url value="/BoardListAction.do?pageNum=1&board_type=freedom"/>">자유 게시판</a>
				</div>
				<div>
					<a href="<c:url value="/BoardListAction.do?pageNum=1&board_type=information"/>">정보 게시판</a>
				</div>
			</header>
			<section>
				<aside>
				...
				<div class="post_list">
				<a  href="<c:url value="/BoardDeleteAction_homepage.do?pageNum=1&board_type=informationo"/>">홈페이지</a>
